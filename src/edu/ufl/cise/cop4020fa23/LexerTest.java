...
//	
	...
	void testReservedWords() throws LexicalException {
		...
		checkToken(CONST,"Z", lexer.next());
		checkToken(CONST,"BLACK", lexer.next());
		checkToken(CONST,"BLUE", lexer.next());
		checkToken(CONST,"CYAN", lexer.next());
		checkToken(CONST,"DARK_GRAY", lexer.next());
		checkToken(CONST,"GRAY", lexer.next());
		checkToken(CONST,"GREEN", lexer.next());
		checkToken(CONST,"LIGHT_GRAY", lexer.next());
		checkToken(CONST,"MAGENTA", lexer.next());
		checkToken(CONST,"ORANGE", lexer.next());
		checkToken(CONST,"PINK", lexer.next());
		checkToken(CONST,"RED", lexer.next());
		checkToken(CONST,"WHITE", lexer.next());
		checkToken(CONST,"YELLOW", lexer.next());
		checkToken(BOOLEAN_LIT,"TRUE", lexer.next());
		checkToken(BOOLEAN_LIT,"FALSE", lexer.next());
		checkToken(COMMA, lexer.next());
		checkToken(SEMI, lexer.next());
